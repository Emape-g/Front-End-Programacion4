...
function Home() {
  ...
  const [participanteEditar, setParticipanteEditar] = useState<Participante | null>(null);
  ...
  const handleGuardar = async (p: Participante) => {
  ...
  return (
    <div className="max-w-6xl mx-auto p-6 bg-gray-50 min-h-screen">
      ...
      <div ref={formRef}>
        <FormularioRegistro
          participanteEditar={participanteEditar}
